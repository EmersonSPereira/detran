...
import br.com.ctis.detran.persistence.ValidatorBase;
import br.com.ctis.detran.persistence.dao.GenericDAO;
import br.com.ctis.detran.persistence.model.EntidadeBase;
...
public abstract class GenericDAOImpl<K extends Serializable, T extends EntidadeBase<K>> implements GenericDAO<K, T> {
	...
	@PersistenceContext(unitName = "br.com.ctis.detran")
